...
class Ear_Nose_Throat:
  ...
  def create_edgelist(self):
    ...
    os.makedirs('Edgelist', exist_ok=True)  #creating a folder for the edgelist if not present
    nx.write_edgelist(self.Directed_Graph,"edgelist/Ear_Nose_Throat.edgelist",delimiter=' , ',data=False) #creating an edgelist from the directed graph and saving the file
  ...
  def visualize_graph(self):
    ...
    os.makedirs('Graph', exist_ok=True)  #creating a folder for the graph if not present
    net.show("graph/Ear_Nose_Throat.html") #saving the created plot of the graph
