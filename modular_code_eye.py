...
class Eye:
  ...
  def create_edgelist(self):
    ...
    nx.write_edgelist(self.Directed_Graph,"edgelist/Eye.edgelist",delimiter=' , ',data=False) #creating an edgelist from the directed graph and saving the file
  ...
  def visualize_graph(self):
    ...
    net.show("graph/Eye.html") #saving the created plot of the graph
