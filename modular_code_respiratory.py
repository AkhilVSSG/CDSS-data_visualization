...
class Respiratory:
  ...
  def create_edgelist(self):
    ...
    nx.write_edgelist(self.Directed_Graph,"edgelist/Respiratory.edgelist",delimiter=' , ',data=False) #creating an edgelist from the directed graph and saving the file
  ...
  def visualize_graph(self):
    ...
    net.show("graph/Respiratory.html") #saving the created plot of the graph
